        ...
        <article className={styles["product"]}>
          <header className={styles["product__header"]}>
            <button
              ...
              className={styles["product__button-exit"]}
            />
            <div className={styles["product__header-info"]}>
              <Heading className={styles["product__heading"]}>
                {product?.title}
              </Heading>
          ...
          <div className={styles["product__info"]}>
            <p className={styles["product__info-text"]}>
              <span className={styles["product__span"]}>Бренд: </span>
              {product?.brand}
            </p>
            <p className={styles["product__info-text"]}>
            ...
            <p className={styles["product__info-text"]}>
              <span className={styles["product__span"]}>Цена: </span>
              {product?.price}$
            </p>
            <p className={styles["product__info-text"]}>
              <span className={styles["product__span"]}>Рейтинг: </span>
              {product?.rating}
            </p>
          </div>
          <Button
            onClick={clickHandler}
            className={styles["product__button-cart"]}
          >
            {isProductInCart()}
          </Button>
        </article>
