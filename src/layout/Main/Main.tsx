...
function Main() {
  ...
  const { cartProducts, totalCount } = useSelector(
  ...
  return (
    <div className={styles["main-layout"]}>
      <aside
        className={cn(styles["sidebar"], styles["main-layout__sidebar"], {
      ...
      >
        ...
        >
          <section className={styles["sidebar__user-info"]}>
            <img
              src={import.meta.env.BASE_URL + "/siba.jpg"}
            ...
            <ul className={styles["navigation__list"]}>
              ...
              <li>
                ...
                >
                  Корзина
                  {totalCount !== 0 && (
                    <span className={styles["navigation__cart-count"]}>
                      {totalCount}
                    </span>
                  )}
                </NavLink>
          ...
          <Button
            ...
            withIcon
            className={styles["sidebar__button-exit"]}
          >
            Выйти
          </Button>
        </div>
      ...
      <main
        onClick={closeMenuByOverlayClickHandler}
        className={styles["main-content"]}
      >
        <button
          onClick={menuClickHandler}
          className={cn(styles["main-content__menu"], {
