    ...
    <div className={styles['main-layout']}>
      ...
      >
        ...
        >
            ...
            <ul className={styles['navigation__list']}>
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(styles['navigation__link'], styles['navigation__link_menu'], {
              ...
              <li>
                <NavLink
                  onClick={() => setIsOpenMenu(false)}
                  className={({ isActive }) =>
                    cn(styles['navigation__link'], styles['navigation__link_cart'], {
                      [styles['navigation__link_active']]: isActive,
                    })
                  }
                  to={'/cart'}
          ...
          <Button onClick={clickHandler} withIcon className={styles['sidebar__button-exit']}>
            Выйти
          </Button>
        </div>
      </aside>
